...
<body>
    ...
    <div class="masuk fixed-top" id="masuk">
        ...
        <form action="" method="POST">
            ...
            <a class="d-flex justify-content-end" href="lupakatasandi.php">Lupa kata sandi?</a>
                ...
                <div class="card align-items-center shadow">
                    <a href="masuk.php">
                        ...
                        <div class="card-body">
                            ...
                            <a href="beli-produk-homepage-laptop.php" class="btn btn-beli mt-2 text-white">Beli</a>
                        </div>
                    </a>
                </div>
            </div>
